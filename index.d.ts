declare module 'hajjtravel-utils' {
     ...
     */
    export function getPhoneNumber(fullPhoneNumber: string, countryCode: string): string;
    export function toFullPhoneNumber(phoneNumber: string, countryCode: string): string;
}
